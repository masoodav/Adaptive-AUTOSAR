...
namespace application
{
    ...
    // void SimpleApp::configureNetworkLayer(const arxml::ArxmlReader &reader)
    // {
    ...
    // helper::NetworkConfiguration SimpleApp::getNetworkConfiguration(
    //     const arxml::ArxmlReader &reader)
    // {
    //     const std::string cNetworkEndpoint{"SimpleAppEP"};
    ...
    // void SimpleApp::configureSdServer(const arxml::ArxmlReader &reader)
    // {
    ...
    // bool SimpleApp::tryConfigureRestCommunication(
    ...
    // DoipLib::ControllerConfig SimpleApp::getDoipConfiguration(
    //     const arxml::ArxmlReader &reader)
    // {
    ...
    // void SimpleApp::configureDoipServer(
